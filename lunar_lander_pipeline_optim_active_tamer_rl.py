...
class LunarLanderSceneGraph:
    ...
    def getCurrGraph(self):
        ...
        self.curr_prob = 0.1 * (1 - self.state_counts[tuple(curr_graph)] / self.max_counts) * max(1, (10 ** (20 / (self.state_counts[tuple(curr_graph)] ** 0.3)) - 0.001 * self.state_counts[tuple(curr_graph)]))
        return curr_graph
