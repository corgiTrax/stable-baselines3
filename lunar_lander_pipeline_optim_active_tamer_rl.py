...
class LunarLanderSceneGraph:
    ...
    def getCurrGraph(self):
        ...
        scaling_factor = 10 ** (20 / (self.state_counts[tuple(curr_graph)] ** 0.3)) if self.state_counts[tuple(curr_graph)]  < 100000 else 1
        self.curr_prob = 0.1 * (1 - self.state_counts[tuple(curr_graph)] / self.max_counts) * scaling_factor
        return curr_graph
