...
def record_state(env):
    ...
    robosuite_states = np.loadtxt("robosuite_states.txt", delimiter=',')
    ...
    np.savetxt("states.txt", states, delimiter=',', newline='\n', fmt='%1.5f')
