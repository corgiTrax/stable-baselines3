...
class ActiveTamerRLSACOptim(OffPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        super(ActiveTamerRLSACOptim, self)._setup_model()
    ...
    def learn(
        ...
        tb_log_name: str = "ActiveTamerRLSACOptim",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(ActiveTamerRLSACOptim, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(ActiveTamerRLSACOptim, self)._excluded_save_params() + [
            "actor",
            "critic",
            "critic_target",
            "human_critic",
        ...
        while should_collect_more_steps(
            ...
            while not done:
                ...
                if (
                    ...
                    state_prediction_err > self.prediction_threshold) and
