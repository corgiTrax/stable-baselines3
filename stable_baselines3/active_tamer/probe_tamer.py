...
class ProbeTamer(OffPolicyAlgorithm):
    ...
    def __init__(
        ...
        model_name: str = "ProbeTamer",
        render: bool = False,
    ):

        super(ProbeTamer, self).__init__(
            policy,
            env,
            SACPolicy,
            learning_rate,
    ...
    def _setup_model(self) -> None:
        super(ProbeTamer, self)._setup_model()
    ...
    def learn(
        ...
        tb_log_name: str = "ProbeTamer",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(ProbeTamer, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(ProbeTamer, self)._excluded_save_params() + [
            "actor",
            "critic",
            "critic_target",
        ]
    ...
    def collect_rollouts(
        ...
        assert env.num_envs == 1, "ProbeTAMER only support single environment"
