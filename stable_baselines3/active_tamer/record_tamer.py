...
class RecordTAMER(OffPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        super(RecordTAMER, self)._setup_model()
    ...
    def learn(
        ...
        tb_log_name: str = "RecordTAMER",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(RecordTAMER, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(RecordTAMER, self)._excluded_save_params() + [
            "actor",
            "critic",
            "critic_target",
        ]
    ...
    def collect_rollouts(
        ...
        assert env.num_envs == 1, "RecordTAMER only support single environment"
