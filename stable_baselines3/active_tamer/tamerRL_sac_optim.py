...
class TamerRLSACOptim(OffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(TamerRLSACOptim, self)._setup_model()
    ...
    def learn(
        ...
        tb_log_name: str = "TamerRLSACOptim",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(TamerRLSACOptim, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(TamerRLSACOptim, self)._excluded_save_params() + [
            "actor",
            "critic",
            "critic_target",
            "human_critic",
